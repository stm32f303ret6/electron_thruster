#!/usr/bin/env python3
"""B&W isometric schematic for the biased +10 V collection case.

Sphere probe biased well above plasma potential inside a cylindrical domain.
Sheath ≈ 5 λ_D.
...
def draw(cfg, dpi):
    ...
    fig.text(0.5, 0.97, "Biased Collection (+10 V)",
             fontsize=18, fontweight="bold", ha="center", va="top",
             color="black")

    out = CASE_DIR / "viz" / "schematic_3_biased_10v.png"
