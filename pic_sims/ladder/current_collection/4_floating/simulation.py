...
capstone's charge-pump mechanism, transcribed from capstone/2_chipsat_thruster/simulation.py:
...
# ======================================================================
# charge pump (capstone/2_chipsat_thruster/simulation.py, transcribed for a one-node sphere)
# ======================================================================
...
def self_capacitance(sim, rmax: float, nz: int) -> float:
    ...
    while the EB is held at a uniform 1 V (capstone/2_chipsat_thruster/simulation.py, verbatim)."""
