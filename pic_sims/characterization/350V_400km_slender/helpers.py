#!/usr/bin/env python3
"""Stage-local physics and configuration for characterization.350V_400km_slender.

Typed config + the derivations of the validated float200 capstone
...
def load_config(path: Path | str, scenario: str | None = None) -> Config:
    ...
    if scenario is not None:
        raise ConfigError("characterization.350V_400km_slender has no scenarios")
