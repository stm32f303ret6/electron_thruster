#!/usr/bin/env python3
"""Stage-local physics and configuration for characterization.350V_400km.

Typed config + the derivations of the validated float200 capstone deck
(same geometry/plasma/numerics, driven at 350 V, one step past the tested ceiling)
...
STAGE_ID = "characterization.350V_400km"
...
def load_config(path: Path | str, scenario: str | None = None) -> Config:
    ...
    if scenario is not None:
        raise ConfigError("characterization.350V_400km has no scenarios")
