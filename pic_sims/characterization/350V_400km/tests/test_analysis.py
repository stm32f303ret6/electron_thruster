...
def _metrics(**over):
    # Plausible 350 V / 0.793 mA values: ~40.5 nN predicted by the frontier
    # F ~ V^2 scaling, float near the collection law's +47 V prediction.
    base = dict(escape_fraction_pct=98.0, f_beam_nN=40.5, phi_body_V=47.0,
...
def test_predicted_350V_400km_values_pass_policy():
