...
| `magnetized_transverse/` | field **perpendicular** to the thrust axis (tier M2, the flight geometry): Cartesian 3D deck, anchor body resolved, Bx = 0 / 30 / 300 µT | `characterization.magnetized_transverse` | 2026-09-01/02 — 1× null CONFIRMED (Δφ +0.3 V, ΔF −0.1 %); 10× at the honest box CHOKES (φ through 150 V, no benign equilibrium: transverse firing infeasible at 10×, M1 field-aligned is the amplified-field mode); settled 6 µs pair PASS 2026-09-04 (18/18): settled float 26.8 V (B=0) / 29.4 V (1×), F 13.9/13.8 nN — thrust/escape null holds settled; float tax +2.6 V |
