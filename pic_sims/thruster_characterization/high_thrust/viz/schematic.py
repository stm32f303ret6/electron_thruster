#!/usr/bin/env python3
"""B&W isometric cutaway of the chipsat thruster can (capstone.high_thrust).

CAD-style drawing: conducting can with lid hole, cathode disk, beam arrow,
dimension lines, and electrical labels.  300 V hardware ceiling.
...
def draw(geo, elec, beam, dpi):
    ...
    fig.text(0.5, 0.97, "High Thrust (300 V ceiling)",
             fontsize=18, fontweight="bold", ha="center", va="top",
             color="black")
    fig.text(0.5, 0.93,
             "Same geometry, driven at the hardware ceiling",
             fontsize=12, ha="center", va="top", color="0.4")

    out = CASE_DIR / "viz" / "schematic_3_high_thrust.png"
