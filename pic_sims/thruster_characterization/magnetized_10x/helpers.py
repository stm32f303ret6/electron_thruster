#!/usr/bin/env python3
"""Stage-local physics and configuration for capstone.floating_body.
...
STAGE_ID = "characterization.magnetized_10x"
...
def load_config(path: Path | str, scenario: str | None = None) -> Config:
    ...
    if scenario is not None:
        raise ConfigError("capstone.floating_body has no scenarios")
