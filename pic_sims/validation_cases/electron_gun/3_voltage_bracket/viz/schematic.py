#!/usr/bin/env python3
"""B&W isometric views of the voltage_bracket test geometry.
...
TITLES = {
    "A_200v_anchor_drive": "Scenario A — Low Current, Small Hole",
    "B_300v_ceiling_drive": "Scenario B — High Current, Small Hole",
    "C_ucurve_overperveance": "Scenario C — High Current, Big Hole",
}
...
def main(argv=None) -> int:
    ...
    for name in names:
        ...
        out = CASE_DIR / "viz" / f"schematic_{name}.png"
