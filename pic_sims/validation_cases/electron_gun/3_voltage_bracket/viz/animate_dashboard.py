#!/usr/bin/env python3
"""Three-scenario dashboard animation for emitter.voltage_bracket.
...
def parse_args(argv=None):
    ap = argparse.ArgumentParser(description="voltage_bracket 3-scenario dashboard")
...
STAGE_INFO = {
    "title": "Holed-Anode Electron Gun (emitter.voltage_bracket)",
    "desc": (
...
def main(argv=None) -> int:
    ...
    lc.check_cohort(cohort, stage_id="emitter.voltage_bracket",
