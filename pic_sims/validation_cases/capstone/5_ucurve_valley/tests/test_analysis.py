...
def _metrics(**over):
    # Plausible H1 values at 125 V / 0.464 mA: delivered thrust on the 13.65 nN
    # demand, float near +24.5 V (model/ucurve_targeting.py, pre-registered
    # in ../UCURVE_PLAN.md).
    base = dict(escape_fraction_pct=96.5, f_beam_nN=13.65, phi_body_V=24.5,
