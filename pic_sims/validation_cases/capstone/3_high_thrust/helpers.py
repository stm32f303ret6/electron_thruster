#!/usr/bin/env python3
"""Stage-local physics and configuration for capstone.high_thrust.

Typed config + the derivations of the validated float200 capstone deck
(same geometry/plasma/numerics, driven at the 300 V hardware ceiling)
...
def load_config(path: Path | str, scenario: str | None = None) -> Config:
    ...
    if scenario is not None:
        raise ConfigError("capstone.high_thrust has no scenarios")
