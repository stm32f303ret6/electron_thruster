#!/usr/bin/env python3
"""B&W isometric cutaway of the chipsat thruster can (capstone.ucurve_floor).

CAD-style drawing: conducting can with lid hole, cathode disk, beam arrow,
dimension lines, and electrical labels.  78 V fixed-thrust throttle point.
...
def draw(geo, elec, beam, dpi):
    ...
    fig.text(0.5, 0.97, "U-curve floor (78 V)",
    ...
    out = CASE_DIR / "viz" / "schematic_7_ucurve_floor.png"
