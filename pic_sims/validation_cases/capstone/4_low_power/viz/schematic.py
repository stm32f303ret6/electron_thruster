#!/usr/bin/env python3
"""B&W isometric cutaway of the chipsat thruster can (capstone.low_power).

CAD-style drawing: conducting can with lid hole, cathode disk, beam arrow,
dimension lines, and electrical labels.  100 V hardware floor.
...
def draw(geo, elec, beam, dpi):
    ...
    fig.text(0.5, 0.97, "Low Power (100 V floor)",
    ...
    out = CASE_DIR / "viz" / "schematic_4_low_power.png"
