#!/usr/bin/env python3
"""Three-panel dashboard animation for capstone.low_power (100 V floor).
...
def parse_args(argv=None):
    ap = argparse.ArgumentParser(description="capstone.low_power dashboard")
...
def main(argv=None) -> int:
    ...
    fig.text(0.5, 0.55, "Low Power (100 V floor)",
