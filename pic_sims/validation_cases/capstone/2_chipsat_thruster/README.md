...
The validated float200 baseline, restructured from the pre-ladder research deck (see `MIGRATION_PLAN.md`; validation audit in `VALIDATION_GAPS.md`).
...
- `max_steps` is floored to a diag-period multiple (−11 steps vs the float200 baseline ≈ −0.06 ns of 800 ns)
