#!/usr/bin/env python3
"""B&W isometric schematic for the floating potential case.

Sphere probe charging to floating potential via charge pump.
Sheath ≈ 1.5 λ_D (small, near-thermal sheath).
...
def draw(cfg, dpi):
    ...
    fig.text(0.5, 0.97, "Floating Potential",
             fontsize=18, fontweight="bold", ha="center", va="top",
             color="black")

    out = CASE_DIR / "viz" / "schematic_4_floating.png"
