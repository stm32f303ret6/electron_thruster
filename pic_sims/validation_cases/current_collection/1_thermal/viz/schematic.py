#!/usr/bin/env python3
"""B&W isometric schematic for the thermal collection case.

Sphere probe at plasma potential inside a cylindrical domain.
No sheath (V_probe = V_plasma).
...
def draw(cfg, dpi):
    ...
    fig.text(0.5, 0.97, "Thermal Collection",
             fontsize=18, fontweight="bold", ha="center", va="top",
             color="black")

    out = CASE_DIR / "viz" / "schematic_1_thermal.png"
