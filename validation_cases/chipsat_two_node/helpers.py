...
chipsat/helpers.py, which transcribed electron_contactor geometry.py: the EB
...
# ======================================================================
# geometry (chipsat/helpers.py, transcribed verbatim)
# ======================================================================
...
class Geometry:
    ...
    Identical to the capstone's Geometry (see chipsat/helpers.py for the full
