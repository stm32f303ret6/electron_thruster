#!/usr/bin/env python3
"""Three-panel dashboard animation for capstone.ucurve_floor (78 V fixed-thrust).
...
def parse_args(argv=None):
    ap = argparse.ArgumentParser(description="capstone.ucurve_floor dashboard")
...
def main(argv=None) -> int:
    ...
    fig.text(0.5, 0.55, "U-curve floor (78 V)",
             fontsize=22, fontweight="bold", ha="center", va="center",
             color="#333333")
    fig.text(0.5, 0.40,
             "Same geometry, fixed-thrust demand at 78 V\n"
    ...
    for fi in range(len(its)):
        ...
        sup.set_text(f"U-curve 78 V    step {it}    t = {t_ns:.1f} ns")
        writer.grab_frame()
