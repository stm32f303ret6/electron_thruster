#!/usr/bin/env python3
"""B&W isometric cutaway of the chipsat thruster can (capstone.ucurve_left_arm).

CAD-style drawing: conducting can with lid hole, cathode disk, beam arrow,
dimension lines, and electrical labels.  92.4 V fixed-thrust throttle point.
...
def draw(geo, elec, beam, dpi):
    ...
    fig.text(0.5, 0.97, "U-curve left arm (92.4 V)",
    ...
    out = CASE_DIR / "viz" / "schematic_6_ucurve_left_arm.png"
