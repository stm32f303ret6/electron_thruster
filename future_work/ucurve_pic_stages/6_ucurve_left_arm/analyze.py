#!/usr/bin/env python3
"""Analysis for capstone.ucurve_left_arm (the chipsat thruster at 92.4 V, fixed 13.65 nN demand).
...
containment, ledger-vs-dump charge consistency), and evaluates the high-thrust
...
def main(argv=None) -> int:
    ...
    try:
        ...
        if len(run_dirs) != 1:
            raise lc.ContractError("capstone.ucurve_left_arm is single-run")
