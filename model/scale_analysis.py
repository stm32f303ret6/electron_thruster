...
def main() -> int:
    ...
    w("float rests on the ±1 %-validated thermal flux plus a small correction.")
    w("**Larger bodies need less extrapolation, not more.**\n")

    w("## Step 5 — the honest caveat: a different sheath regime\n")
    ...
    w("orbital-motion fan. Using that (Child-sheath) model instead — an")
    ...
    w("and a large-body PIC run is cheap: lower χ settles faster than anything")
    w("already run.\n")
