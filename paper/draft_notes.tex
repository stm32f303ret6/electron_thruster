...
\begin{itemize}
  \item \textbf{550--600\,km:} drag compensation closes on body-mounted solar
        power (8--17\,mW mean demand vs $\sim$30\,mW harvest), 25--32\% duty
        cycles
  \item \textbf{500\,km:} closes on impulse but power-bound at the mean
        (39\,mW) --- closure relies on thrusting preferentially when plasma is
        dense and charging tax low
  \item \textbf{400\,km: does not close} for this body --- demand exceeds
        emission ceiling 63\% of the time
\end{itemize}
...
silhouette, collection and solar harvest buy the total skin.  a slender body
...
$\propto A_{\mathrm{ram}}$.  solar harvest $\propto A_{\mathrm{skin}}$.
...
\midrule
\multicolumn{5}{l}{\emph{margin = harvest / demand at 100\,V; $>$1 closes}} \\
...
\end{tabular}
\end{center}
{\small\itshape harvest assumes 30\% cells over $\frac{1}{3}$ skin at 25\%
orbit-average illumination (102\,W/m$^2$ of cell area).}
...
\begin{enumerate}
  ...
  \item \textbf{the mission corridor is honest:} closure on harvested power at
        550--600\,km, impulse closure at 500\,km, failure at 400\,km stated
