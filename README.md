...
They are estimates from an extrapolated collection law, not measurements, and the extrapolation crosses a regime boundary (risk 4 below).
...
| `model/MODEL.md` | the executable model, control law, mission table |
