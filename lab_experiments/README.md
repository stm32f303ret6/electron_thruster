...
|---|---|---|
| [`electron_gun/`](electron_gun/README.md) | a net-negative cathode both emits and accelerates electrons onto a grounded collector (≈ 87 mA at −56 V, ≈ 5 Pa) | step 1, `emitter.negative_cathode` |
